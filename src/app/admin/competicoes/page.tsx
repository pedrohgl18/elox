          ...
          return (
            <div key={c.id} className="border border-slate-800 bg-slate-900/60 rounded-xl p-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-slate-400 text-xs mt-1">{formatDateShort(c.startDate)} → {formatDateShort(c.endDate)} • CPM R$ {c.rules.cpm.toFixed(2)} • Status: <span className="text-slate-200">{st}</span></div>
              </div>
