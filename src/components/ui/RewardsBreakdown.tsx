...
export default function RewardsBreakdown() {
  return (
    <Reveal as="section" className="overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-b from-white to-sky-50 p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <p className="mt-1 break-words text-pretty text-sm leading-relaxed text-slate-600">
